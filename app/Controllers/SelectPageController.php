...
class SelectPageController extends BaseController {
    
    public function __construct(){
        $panelModel = new PanelModel();
        $this->settings = $panelModel->getSettings();
        $this->details = new SelectPageModel();
    }
    ...
    public function create(){
        ...
        $data = [
            'pageTitle' => 'Create Select Page',
            'currentFile' => 'settings_app_ui',
            'pageSave' => 'Create'
        ];
        $data['settings'] = $this->settings;
        return view('create_select_page', $data);
    }
    ...
    public function edit($id = null){
        ...
        $data = [
            'pageTitle' => 'Edit Select Page',
            'currentFile' => 'settings_app_ui',
            'pageSave' => 'Save',
            'select_id' => $dataDetails['id'],
            'row' => $dataDetails,
        ];
        $data['settings'] = $this->settings;
        return view('create_select_page', $data);
    ...
    public function createHandler(){
        ...
        $editID = $this->request->getPost('select_id');
        ...
        if (empty($postedToken)) {
            ...
            if(empty($editID)){
              ...
              return redirect()->to(base_url('ns-admin/create-select/'.$editID));  
            }
        }
        ...
        if(empty($editID)){
            ...
            $data = array(
                ...
                'redirect_type'  =>  $this->request->getPost('redirect_type'),
                'page_data'  =>  $this->request->getPost('page_data'),
                'status' => '1'
            );
