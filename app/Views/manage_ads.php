        ...
        <div class="card h-100">
            <div class="card-top d-md-inline-flex align-items-center justify-content-between py-3 px-4">
                ...
                <div class="d-flex mt-2 mt-md-0">
                    ...
                    <a href="<?= base_url('ns-admin/create-ads') ?>" class="btn btn-primary d-inline-flex align-items-center justify-content-center">
                        ...
                        <?php $i=0; foreach($result as $row){ ?>
                            <div class="col-lg-3 col-sm-6 card-item">
                                <div class="nsofts-card-light p-3">
                                    <h5 class="mb-2 text-truncate"><?= esc($row['ads_title']) ?></h5>
                                    <p><?= esc($row['ads_type']) ?></p>
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex">
                                            <a href="<?= base_url('ns-admin/create-ads/'.$row['id']) ?>" class="btn btn-outline-primary rounded-pill me-2 btn-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                                <i class="ri-pencil-line"></i>
                                            </a>
                                            <a href="javascript:void(0)" class="btn btn-outline-danger rounded-pill me-2 btn-icon btn_delete" data-action="<?= base_url('ns-admin/delete-ads/'.$row['id']) ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete">
                                        ...
                                        <div class="nsofts-switch d-flex align-items-center enable_disable" data-bs-toggle="tooltip" data-bs-placement="top" title="Enable / Disable">
                                            <input type="checkbox" id="enable_disable_check_<?= $i ?>" data-action="<?= base_url('ns-admin/status-ads/'.$row['id']) ?>" data-column="status" class="cbx hidden btn_enable_disable" <?php if ($row['status'] == 1) { echo 'checked'; } ?>>
